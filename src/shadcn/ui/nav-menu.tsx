...
const navigationMenuTriggerStyle = cva(
  "group inline-flex w-max items-center justify-center leading-5 px-2 py-1 font-semibold text-white disabled:pointer-events-none disabled:opacity-50 rounded hover:bg-blue-600 outline-none transition-[color,box-shadow]"
);
